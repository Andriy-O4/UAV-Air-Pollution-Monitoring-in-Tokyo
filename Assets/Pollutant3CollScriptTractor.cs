...
public class Pollutant3CollScriptTractor : MonoBehaviour
{

    // Trigger collider variables: 
    private Tractor3MoveScript TriggerObtainer; // Script to obtain prefab pollution sensor collider 
    ...
    void Start()
    {
        ...
        // Trigger collider variables: 
        TriggerObtainer = FindObjectOfType<Tractor3MoveScript>();
