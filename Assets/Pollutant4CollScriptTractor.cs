...
public class Pollutant4CollScriptTractor : MonoBehaviour
{

    // Trigger collider variables: 
    private Tractor4MoveScript TriggerObtainer; // Script to obtain prefab pollution sensor collider 
    ...
    void Start()
    {
        ...
        // Trigger collider variables: 
        TriggerObtainer = FindObjectOfType<Tractor4MoveScript>();
