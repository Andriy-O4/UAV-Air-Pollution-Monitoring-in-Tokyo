...
public class Pollutant1CollScript : MonoBehaviour
{

    // Trigger collider variables: 
    private PDNAOptimScript TriggerObtainer; // Script to obtain prefab pollution sensor collider 
    ...
    void Start()
    {
        ...
        // Trigger collider variables: 
        TriggerObtainer = FindObjectOfType<PDNAOptimScript>();
