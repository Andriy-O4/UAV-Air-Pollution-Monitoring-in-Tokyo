...
public class Tractor4MoveScript : MonoBehaviour
{
    ...
    private Pollutant4CollScriptTractor collScript1;
    ...
    void Start()
    {
        ...
        collScript1 = FindObjectOfType<Pollutant4CollScriptTractor>(); // Obtaining references to other scripts 
        ...
        filename1 = Application.dataPath + "/UAV4_ResultsTractor.csv"; // Defining filepath for performance metrics results for each test run 
        filename2 = Application.dataPath + "/UAV4_TractorConcMap.csv";
        filename3 = Application.dataPath + "/UAV4_TractorMaxMap.csv";
