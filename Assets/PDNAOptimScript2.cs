...
public class PDNAOptimScript2 : MonoBehaviour
{
    // CHANGE IN CODE: 
    ...
    private Pollutant2CollScript collScript1;
    ...
    void Start()
    {
        ...
        collScript1 = FindObjectOfType<Pollutant2CollScript>(); // Obtaining references to other scripts 
        ...
        filename1 = Application.dataPath + "/UAV2_ResultsPDNA.csv"; // Defining filepath for performance metrics results for each test run 
        filename2 = Application.dataPath + "/UAV2_PDNAConcMap.csv";
