...
public class PDNAOptimScript3 : MonoBehaviour
{
    // CHANGE IN CODE: 
    ...
    private Pollutant3CollScript collScript1;
    ...
    void Start()
    {
        ...
        collScript1 = FindObjectOfType<Pollutant3CollScript>(); // Obtaining references to other scripts 
        ...
        filename1 = Application.dataPath + "/UAV3_ResultsPDNA.csv"; // Defining filepath for performance metrics results for each test run 
        filename2 = Application.dataPath + "/UAV3_PDNAConcMap.csv";
