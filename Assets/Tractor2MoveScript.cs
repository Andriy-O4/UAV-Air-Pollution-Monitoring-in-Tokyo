...
public class Tractor2MoveScript : MonoBehaviour
{
    ...
    private Pollutant2CollScriptTractor collScript1;
    ...
    void Start()
    {
        ...
        collScript1 = FindObjectOfType<Pollutant2CollScriptTractor>(); // Obtaining references to other scripts 
        ...
        filename1 = Application.dataPath + "/UAV2_ResultsTractor.csv"; // Defining filepath for performance metrics results for each test run 
        filename2 = Application.dataPath + "/UAV2_TractorConcMap.csv";
