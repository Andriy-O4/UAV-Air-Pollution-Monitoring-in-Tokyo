...
public class Pollutant1CollScriptTractor : MonoBehaviour
{

    // Trigger collider variables: 
    private Tractor1MoveScript TriggerObtainer; // Script to obtain prefab pollution sensor collider 
    ...
    void Start()
    {
        ...
        // Trigger collider variables: 
        TriggerObtainer = FindObjectOfType<Tractor1MoveScript>();
