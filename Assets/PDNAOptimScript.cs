...
public class PDNAOptimScript : MonoBehaviour
{
    // CHANGE IN CODE: 
    ...
    private Pollutant1CollScript collScript1;
    ...
    void Start()
    {
        ...
        collScript1 = FindObjectOfType<Pollutant1CollScript>(); // Obtaining references to other scripts 
        ...
        filename1 = Application.dataPath + "/UAV1_ResultsPDNA.csv"; // Defining filepath for performance metrics results for each test run 
        filename2 = Application.dataPath + "/UAV1_PDNAConcMap.csv";
