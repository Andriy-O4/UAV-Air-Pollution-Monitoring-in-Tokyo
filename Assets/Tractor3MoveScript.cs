...
public class Tractor3MoveScript : MonoBehaviour
{
    ...
    private Pollutant3CollScriptTractor collScript1;
    ...
    void Start()
    {
        ...
        collScript1 = FindObjectOfType<Pollutant3CollScriptTractor>(); // Obtaining references to other scripts 
        ...
        filename1 = Application.dataPath + "/UAV3_ResultsTractor.csv"; // Defining filepath for performance metrics results for each test run 
        filename2 = Application.dataPath + "/UAV3_TractorConcMap.csv";
